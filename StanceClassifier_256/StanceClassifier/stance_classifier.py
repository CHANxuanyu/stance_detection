...
class StanceClassifierWithTarget(StanceClassifier):
    ...
    def __init__(
        self,
        model="GateNLP/stance-bertweet-target-aware",
        feature_extractor=None,
        max_length=None,
        truncation_strategy="longest_first",
    ):
        ...
        super().__init__(model, feature_extractor, max_length=max_length, truncation_strategy=truncation_strategy)
...
class StanceClassifierEnsemble:
    ...
    def __init__(
        self,
        to_model="GateNLP/stance-bertweet-target-oblivious",
        ta_model="GateNLP/stance-bertweet-target-aware",
        feature_extractor=None,
        max_length=None,
        truncation_strategy="longest_first",
    ):
        self.ta_classifier = StanceClassifierWithTarget(
            ta_model,
            feature_extractor,
            max_length=max_length,
            truncation_strategy=truncation_strategy,
        ...
        self.to_classifier = StanceClassifier(
            to_model,
            self.ta_classifier.feature_extractor,
            max_length=max_length,
            truncation_strategy=truncation_strategy,
        )
